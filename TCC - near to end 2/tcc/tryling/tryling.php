<!--<script
      type="module"
      crossorigin
      src="/Github/server/assets/index-f6754329.js"
    ></script> -->
...
<body>
  <header class="header">
    <nav class="navigation">
      ...
      <a id="tryling" href="tryling.php">Tryling</a> <a id="profile" href="profile.php">meu perfil</a>
  ...
  <main>
    ...
    <div id="nacional-imgs">
          ...
          <div class="img-flag">
           <a href="planodecurso.php"> <img src="assets/BR.png" alt="bandeira do brasil"></a>
         </div>
       
         <div class="img-flag">
           <a href="planodecurso.php"><img src="assets/EUA.png" alt="bandeira do estados unidos da américa"></a>
         </div>
